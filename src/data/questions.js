...
const questions = {
  ...
  "US States": [
    { "q": "What is the capital of Texas?", "options": ["Houston", "Dallas", "Austin", "San Antonio"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Sunshine State'?", "options": ["California", "Florida", "Arizona", "Hawaii"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the largest state by area?", "options": ["Texas", "California", "Montana", "Alaska"], "correct": 3, "pool": "multiplayer" },
    { "q": "Which state has the most population?", "options": ["Texas", "California", "Florida", "New York"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of California?", "options": ["Los Angeles", "San Francisco", "Sacramento", "San Diego"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Lone Star State'?", "options": ["Arizona", "New Mexico", "Texas", "Oklahoma"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the smallest state by area?", "options": ["Delaware", "Connecticut", "Rhode Island", "New Jersey"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Empire State'?", "options": ["Pennsylvania", "New Jersey", "Massachusetts", "New York"], "correct": 3, "pool": "multiplayer" },
    { "q": "What is the capital of New York?", "options": ["New York City", "Buffalo", "Albany", "Rochester"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state was the first to ratify the Constitution?", "options": ["Pennsylvania", "Delaware", "New Jersey", "Georgia"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Florida?", "options": ["Miami", "Orlando", "Tampa", "Tallahassee"], "correct": 3, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Golden State'?", "options": ["Nevada", "California", "Arizona", "Colorado"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Pennsylvania?", "options": ["Philadelphia", "Pittsburgh", "Harrisburg", "Allentown"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state borders the most other states?", "options": ["Texas", "Missouri", "Tennessee", "Kentucky"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Ohio?", "options": ["Cleveland", "Cincinnati", "Columbus", "Toledo"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Buckeye State'?", "options": ["Indiana", "Illinois", "Ohio", "Michigan"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Georgia?", "options": ["Savannah", "Augusta", "Atlanta", "Macon"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Peach State'?", "options": ["South Carolina", "Georgia", "Alabama", "Mississippi"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Illinois?", "options": ["Chicago", "Springfield", "Peoria", "Rockford"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Land of Lincoln'?", "options": ["Kentucky", "Indiana", "Illinois", "Missouri"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Michigan?", "options": ["Detroit", "Grand Rapids", "Lansing", "Ann Arbor"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Great Lake State'?", "options": ["Wisconsin", "Minnesota", "Michigan", "Ohio"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Arizona?", "options": ["Tucson", "Phoenix", "Mesa", "Scottsdale"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Grand Canyon State'?", "options": ["Utah", "Nevada", "Arizona", "Colorado"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Colorado?", "options": ["Colorado Springs", "Boulder", "Denver", "Aurora"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Centennial State'?", "options": ["Montana", "Wyoming", "Colorado", "Utah"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Washington?", "options": ["Seattle", "Spokane", "Olympia", "Tacoma"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Evergreen State'?", "options": ["Oregon", "Washington", "Idaho", "Montana"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Oregon?", "options": ["Portland", "Eugene", "Salem", "Bend"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Beaver State'?", "options": ["Washington", "Idaho", "Oregon", "Montana"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Nevada?", "options": ["Las Vegas", "Reno", "Carson City", "Henderson"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Silver State'?", "options": ["Colorado", "Nevada", "Arizona", "Utah"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Massachusetts?", "options": ["Worcester", "Springfield", "Boston", "Cambridge"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Bay State'?", "options": ["Connecticut", "Rhode Island", "Massachusetts", "Maine"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Virginia?", "options": ["Virginia Beach", "Norfolk", "Richmond", "Alexandria"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Old Dominion'?", "options": ["Maryland", "Virginia", "West Virginia", "North Carolina"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of North Carolina?", "options": ["Charlotte", "Raleigh", "Durham", "Greensboro"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Tar Heel State'?", "options": ["South Carolina", "North Carolina", "Virginia", "Georgia"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Tennessee?", "options": ["Memphis", "Knoxville", "Nashville", "Chattanooga"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Volunteer State'?", "options": ["Kentucky", "Tennessee", "Alabama", "Mississippi"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Kentucky?", "options": ["Louisville", "Lexington", "Frankfort", "Bowling Green"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Bluegrass State'?", "options": ["Tennessee", "West Virginia", "Kentucky", "Virginia"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Louisiana?", "options": ["New Orleans", "Baton Rouge", "Shreveport", "Lafayette"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Pelican State'?", "options": ["Mississippi", "Alabama", "Louisiana", "Florida"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Missouri?", "options": ["St. Louis", "Kansas City", "Jefferson City", "Springfield"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Show-Me State'?", "options": ["Kansas", "Missouri", "Iowa", "Nebraska"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Indiana?", "options": ["Fort Wayne", "Evansville", "Indianapolis", "South Bend"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Hoosier State'?", "options": ["Ohio", "Michigan", "Indiana", "Illinois"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Wisconsin?", "options": ["Milwaukee", "Green Bay", "Madison", "Kenosha"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Badger State'?", "options": ["Minnesota", "Iowa", "Wisconsin", "Michigan"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Minnesota?", "options": ["Minneapolis", "St. Paul", "Duluth", "Rochester"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is known as the 'North Star State'?", "options": ["Wisconsin", "Minnesota", "North Dakota", "Montana"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Iowa?", "options": ["Cedar Rapids", "Des Moines", "Davenport", "Sioux City"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Hawkeye State'?", "options": ["Nebraska", "Kansas", "Iowa", "Missouri"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Kansas?", "options": ["Wichita", "Kansas City", "Topeka", "Overland Park"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Sunflower State'?", "options": ["Nebraska", "Kansas", "Oklahoma", "Missouri"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Nebraska?", "options": ["Omaha", "Lincoln", "Bellevue", "Grand Island"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Cornhusker State'?", "options": ["Iowa", "Kansas", "Nebraska", "South Dakota"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Oklahoma?", "options": ["Tulsa", "Norman", "Oklahoma City", "Lawton"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Sooner State'?", "options": ["Texas", "Kansas", "Oklahoma", "Arkansas"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Arkansas?", "options": ["Fort Smith", "Fayetteville", "Little Rock", "Jonesboro"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Natural State'?", "options": ["Tennessee", "Arkansas", "Missouri", "Louisiana"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Alabama?", "options": ["Birmingham", "Mobile", "Montgomery", "Huntsville"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Heart of Dixie'?", "options": ["Georgia", "Mississippi", "Alabama", "Louisiana"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Mississippi?", "options": ["Biloxi", "Gulfport", "Jackson", "Hattiesburg"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Magnolia State'?", "options": ["Alabama", "Mississippi", "Louisiana", "Georgia"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of South Carolina?", "options": ["Charleston", "Greenville", "Columbia", "Myrtle Beach"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Palmetto State'?", "options": ["North Carolina", "South Carolina", "Georgia", "Florida"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of West Virginia?", "options": ["Huntington", "Morgantown", "Charleston", "Parkersburg"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Mountain State'?", "options": ["Virginia", "West Virginia", "Kentucky", "Tennessee"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Maryland?", "options": ["Baltimore", "Annapolis", "Rockville", "Frederick"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Old Line State'?", "options": ["Delaware", "Maryland", "Virginia", "Pennsylvania"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of New Jersey?", "options": ["Newark", "Jersey City", "Trenton", "Paterson"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Garden State'?", "options": ["Connecticut", "New Jersey", "Delaware", "Rhode Island"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Connecticut?", "options": ["Bridgeport", "New Haven", "Hartford", "Stamford"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Constitution State'?", "options": ["Massachusetts", "Connecticut", "Rhode Island", "New Hampshire"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of New Hampshire?", "options": ["Manchester", "Nashua", "Concord", "Portsmouth"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Granite State'?", "options": ["Vermont", "New Hampshire", "Maine", "Massachusetts"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Vermont?", "options": ["Burlington", "Rutland", "Montpelier", "Barre"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Green Mountain State'?", "options": ["New Hampshire", "Vermont", "Maine", "Massachusetts"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Maine?", "options": ["Portland", "Lewiston", "Augusta", "Bangor"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Pine Tree State'?", "options": ["Vermont", "New Hampshire", "Maine", "Massachusetts"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Rhode Island?", "options": ["Warwick", "Cranston", "Providence", "Pawtucket"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Ocean State'?", "options": ["Connecticut", "Massachusetts", "Rhode Island", "New Jersey"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Delaware?", "options": ["Wilmington", "Newark", "Dover", "Middletown"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'First State'?", "options": ["Pennsylvania", "Delaware", "New Jersey", "Maryland"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Hawaii?", "options": ["Maui", "Kona", "Honolulu", "Hilo"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Aloha State'?", "options": ["California", "Florida", "Hawaii", "Alaska"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Alaska?", "options": ["Anchorage", "Fairbanks", "Juneau", "Sitka"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Last Frontier'?", "options": ["Montana", "Wyoming", "Alaska", "Idaho"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Utah?", "options": ["Provo", "Ogden", "Salt Lake City", "St. George"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Beehive State'?", "options": ["Nevada", "Utah", "Idaho", "Wyoming"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of New Mexico?", "options": ["Albuquerque", "Las Cruces", "Santa Fe", "Rio Rancho"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Land of Enchantment'?", "options": ["Arizona", "New Mexico", "Colorado", "Nevada"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Idaho?", "options": ["Boise", "Nampa", "Meridian", "Idaho Falls"], "correct": 0, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Gem State'?", "options": ["Montana", "Wyoming", "Idaho", "Nevada"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of Montana?", "options": ["Billings", "Missoula", "Helena", "Great Falls"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Treasure State'?", "options": ["Wyoming", "Montana", "Idaho", "Nevada"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of Wyoming?", "options": ["Casper", "Laramie", "Cheyenne", "Gillette"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state is known as the 'Cowboy State'?", "options": ["Montana", "Wyoming", "Colorado", "Texas"], "correct": 1, "pool": "multiplayer" },
    { "q": "What is the capital of North Dakota?", "options": ["Fargo", "Grand Forks", "Bismarck", "Minot"], "correct": 2, "pool": "multiplayer" },
    { "q": "What is the capital of South Dakota?", "options": ["Sioux Falls", "Rapid City", "Pierre", "Aberdeen"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which two states share the 'Dakota' name?", "options": ["North & South Dakota", "East & West Dakota", "Upper & Lower Dakota", "Old & New Dakota"], "correct": 0, "pool": "multiplayer" },
    { "q": "Which state has the highest population density?", "options": ["Rhode Island", "New Jersey", "Massachusetts", "Connecticut"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state has the lowest population?", "options": ["Vermont", "Wyoming", "Alaska", "North Dakota"], "correct": 1, "pool": "multiplayer" },
    { "q": "How many states border Canada?", "options": ["11", "12", "13", "14"], "correct": 2, "pool": "multiplayer" },
    { "q": "How many states border Mexico?", "options": ["3", "4", "5", "6"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state has the longest coastline?", "options": ["Florida", "California", "Alaska", "Hawaii"], "correct": 2, "pool": "multiplayer" },
    { "q": "Which state was the 50th to join the Union?", "options": ["Alaska", "Hawaii", "Arizona", "New Mexico"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state was the 49th to join the Union?", "options": ["Alaska", "Hawaii", "Arizona", "New Mexico"], "correct": 0, "pool": "multiplayer" },
    { "q": "In which state is Mount Rushmore located?", "options": ["North Dakota", "South Dakota", "Wyoming", "Montana"], "correct": 1, "pool": "multiplayer" },
    { "q": "In which state is the Grand Canyon located?", "options": ["Utah", "Colorado", "Arizona", "Nevada"], "correct": 2, "pool": "multiplayer" },
    { "q": "In which state is Yellowstone National Park primarily located?", "options": ["Montana", "Wyoming", "Idaho", "Colorado"], "correct": 1, "pool": "multiplayer" },
    { "q": "Which state is completely surrounded by other states (landlocked)?", "options": ["Kansas", "Nebraska", "Wyoming", "All of the above"], "correct": 3, "pool": "multiplayer" },
    { "q": "Which state has 'Live Free or Die' as its motto?", "options": ["Vermont", "New Hampshire", "Maine", "Massachusetts"], "correct": 1, "pool": "multiplayer" }
  ]
};
