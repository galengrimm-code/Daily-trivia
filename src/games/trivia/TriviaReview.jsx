...
import { Check, Zap, ArrowLeft, Loader } from 'lucide-react';
import { CATEGORIES } from '../../utils/helpers';
import { loadTodaysQuestions } from '../../utils/api';

export default function TriviaReview({ questions: initialQuestions, onBack }) {
            ...
            return (
              <div key={idx} className="bg-white rounded-card p-4 shadow-card">
                ...
                <div className="flex items-center gap-2 bg-green-50 rounded-lg p-3 border border-green-200">
                  ...
                  <span className="text-green-700 font-medium">{question.options[question.correct]}</span>
                </div>
