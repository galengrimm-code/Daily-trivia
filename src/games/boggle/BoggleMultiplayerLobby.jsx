// src/games/boggle/BoggleMultiplayerLobby.jsx
import React, { useState } from 'react';
import { ArrowLeft, Copy, Check, Users } from 'lucide-react';

export default function BoggleMultiplayerLobby({
                ...
                {lobbies.map(lobby => (
                  ...
                  >
                    <div className="text-left">
                      ...
                      <span className="text-green-600 text-sm ml-2">{lobby.playerCount}/8</span>
                    </div>
